...
# Criar uma nova imagem em branco com as mesmas dimensões do QR Code
width, height = img_url.size
...
# Criar o texto do QR Code com as informaçõesa
...
# Salvar a imagem
img.save("imagem_com_qrcode.png")
